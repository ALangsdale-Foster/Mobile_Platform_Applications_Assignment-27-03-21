...
public class TwoPlayerActivity extends AppCompatActivity{
            ...
            if (text.getText().toString().equals("None")) {
                ...
                if (aiflag == false) {
                    if (checkName(receivedData)) {
                        ...
                        Toast.makeText(TwoPlayerActivity.this, "Hero already chosen/banned", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public void calcScore(ArrayList<String> p1, ArrayList<String> p2) {
        ...
        if (score1 > score2) {
            Toast.makeText(TwoPlayerActivity.this, "Player Wins with score: " + score1 + " vs AI's " + score2, Toast.LENGTH_LONG).show();
        } else if (score2 > score1) {
            Toast.makeText(TwoPlayerActivity.this, "AI Wins with score: " + score2 + " vs Player's " + score1, Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(TwoPlayerActivity.this, "The game is a draw with " + score2, Toast.LENGTH_LONG).show();
        }
